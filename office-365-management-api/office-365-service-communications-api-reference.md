...
The status definitions include the following values: Investigating, RestoringService, VerifyingService, ServiceRestored, PostIncidentReportPublished, ServiceDegradation, ServiceInterruption, and ExtendedRecovery. 
